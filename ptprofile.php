...
if (isset($_POST['text']))
{
	...
	$query = "SELECT * FROM ptprofiles WHERE user='$user'";
	if (mysql_num_rows(queryMysql($query)))
	{
		queryMysql("UPDATE ptprofiles SET text='$text' 
				    where user='$user'");
	}
	else
	{
		$query = "INSERT INTO ptprofiles VALUES('$user', '$text')";
		queryMysql($query);
	}
}
else
...
echo <<<_END
<form method='post' action='ptprofile.php'
